...
const ACTION_BADGE = {
  ...
  TASK_WORK_SUBMITTED:    { label: "Task Submitted",    color: "bg-amber-100 text-amber-700" },
  TASK_COMPLETED:         { label: "Task Completed",    color: "bg-emerald-100 text-emerald-800" },
  CLIENT_APPROVED:        { label: "Client Approved",   color: "bg-green-100 text-green-700" },
  CLIENT_REJECTED_TASK:   { label: "Client Rejected",   color: "bg-red-100 text-red-700" },
