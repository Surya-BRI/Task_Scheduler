                  ...
                  <div className="flex items-center justify-between mt-auto gap-1">
                    ...
                    <div className="flex items-center gap-0.5 shrink-0" onClick={(e) => e.stopPropagation()}>
                      <button
                        ...
                        className="grid h-6 w-6 place-items-center rounded-full bg-white/90 text-emerald-600 ring-1 ring-gray-200 hover:bg-emerald-50"
                        title="Start timer"
                      >
                      ...
                      <button
                        ...
                        className="grid h-6 w-6 place-items-center rounded-full bg-white/90 text-amber-500 ring-1 ring-gray-200 hover:bg-amber-50"
                        title="Pause timer"
                      >
                        <Pause size={11} />
                      </button>
                      <button
                        ...
                        className="grid h-6 w-6 place-items-center rounded-full bg-white/90 text-red-600 ring-1 ring-gray-200 hover:bg-red-50"
