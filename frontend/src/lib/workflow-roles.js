...
export const DEPARTMENT_MANAGER_ROLES = ['HOD', 'ADMIN', 'SALESPERSON']
...
/** Leave / OT / regularization approvers — HOD and ADMIN (Sales does not approve HR requests). */
export const HR_APPROVER_ROLES = ['HOD', 'ADMIN']
