...
export function UnifiedFilterPanel({
  ...
  return (
    <div
      onClick={onClose}
      className="fixed inset-0 z-40 bg-black/20 p-3 sm:absolute sm:inset-auto sm:right-0 sm:top-11 sm:w-[380px] sm:bg-transparent sm:p-0"
    >
      <div
      ...
      >
        ...
        <div className="space-y-3">
          <FilterDropdown
            ...
            values={draftFilters.types}
            onChange={(types) => onDraftChange({ ...draftFilters, types })}
            multiple
            className="w-full"
          />
          ...
          <FilterDropdown
            ...
            optionRenderer={(item) => {
              ...
              return (
                <span
                  className={`inline-flex items-center rounded px-2 py-0.5 text-[11px] font-semibold ring-1 ring-inset ${style}`}
                >
                  {item.label}
                </span>
              )
          ...
          <FilterDropdown
            ...
            options={salesPersonOptions.map((value) => ({ value, label: value }))}
          ...
          <div>
            ...
            <DateRangeFilter
              startDate={draftFilters.createdDateRange.startDate}
              endDate={draftFilters.createdDateRange.endDate}
